...
export async function installCommands(
  ...
  log.hint(
    'Use them in Claude Code: /mini:init, /mini:next, /mini:discuss, /mini:plan, /mini:do, /mini:verify, /mini:adversarial, /mini:adversarial-project, /mini:security, /mini:done, /mini:auto, /mini:status, /mini:map, /mini:audit, /mini:undo, /mini:model',
  );
