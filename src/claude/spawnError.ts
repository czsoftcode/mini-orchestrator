...
export const CLAUDE_NOT_FOUND_MESSAGE =
  'Příkaz „claude" nenalezen — vypadá to, že Claude Code není nainstalovaný nebo není v PATH.\n' +
 ...
 */
export function describeSpawnError(err: NodeJS.ErrnoException): Error {
  if (err.code === 'ENOENT') {
