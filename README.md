...
| `mini verify` | Hloubková UI/UX kontrola fáze člověkem — Claude tě interaktivně provede vizuální/UX kontrolou (vyjde z `verify` bodů reportu); read-only, stav neposouvá. Cílí na aktuální fázi, jinak na poslední uzavřenou |
...
/mini:verify         # hloubková UI/UX kontrola fáze člověkem (read-only)
