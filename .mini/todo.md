...
- [x] C/C++ language mapper for mini map (only major gap in language coverage)
...
- [ ] zápis adversarial mimo run phase do samostatného adresáře, ať se z toho čerpá pro další fáze
