...
- [x] Decide and wire finding closing into the do/done lifecycle (e.g. offer to close additional open findings at the done checkpoint), beyond the standalone CLI and the --from-finding auto-close.
