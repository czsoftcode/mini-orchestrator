...
- [ ] Robustify findings metadata parsing (fix 160-3 order-locked parse + 160-2 unknown-source downgrade), then add optional --reason to 'mini findings resolve' to record why a finding was closed.
