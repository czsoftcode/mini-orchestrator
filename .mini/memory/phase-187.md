# Phase 187 — Close extra findings at done

**Goal:** At the mini done checkpoint, surface open findings as candidates and let the user close additional ones via a repeatable --resolve-finding <id> flag, recording them on the phase so mini undo reopens them symmetrically.

## Steps
- [done] Add resolvedFindings field to Phase
- [done] Resolve & record extra findings in finalize
- [done] Thread option + CLI flag --resolve-finding
- [done] Undo reopens recorded extra findings
- [done] Surface open findings at done checkpoint
- [done] Tests for the full path
