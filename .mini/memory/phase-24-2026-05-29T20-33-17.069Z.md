# Fáze 24 — Bod 2. z .mini/improvements.md

**Cíl:** Hotové fáze C1 - C3

## Kroky
- [hotovo] Zdokumentovat živé MEMORY_* symboly ve writeMemory.ts (C1)
- [hotovo] Odstranit zavádějící TODO o jejich smazání (C1)
- [hotovo] Přidat migraci state.model → models.default ve store.load (C2)
- [hotovo] Zrušit fallbacky na state.model v models.ts a status.ts (C2)
- [hotovo] Zúžit typ PermissionMode na reálně používané hodnoty (C3)
- [hotovo] Doplnit/upravit testy pro migraci a PermissionMode
- [hotovo] Ověřit zelené testy a čistý tsc --noEmit
