...
**Cíl:** Přidat csharpMapper (mapCSharpFile) parsující .cs soubory (usingy, namespace, třídy/struct/interface/enum/record, metody) a zapojit C# do buildGraph (Lang, detectLang na .cs, hasMappableProject přes .csproj/.sln) i graphHintu, vč. testů a zeleného buildu.

## Kroky
- [hotovo] Kostra csharpMapperu + stripCSharp
- [hotovo] Usingy a namespace
- [hotovo] Typy a členy
- [hotovo] Zapojení do buildGraph
- [hotovo] Testy a zelený build

## Auto-commit
- Fáze 56: Mapa pro C# (`02917529386cd412a2f3d31e10268d0bb35e6d86`)
