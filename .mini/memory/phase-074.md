# Fáze 74 — Překlad audit + import promptů do AJ

**Cíl:** Přeložit do angličtiny prompty auditCodebase.ts a importGsd.ts (ani jeden nepoužívá sdílený graph hint) a aktualizovat jejich snapshot testy; npm test a build zelené.

## Kroky
- [hotovo] auditCodebase.ts → AJ
- [hotovo] importGsd.ts → AJ
