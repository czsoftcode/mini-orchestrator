# Phase 88 — Global install instaluje bez TTY

**Goal:** Při globální instalaci (npm i -g, detekováno přes npm_config_global) postinstall i bez TTY tiše nainstaluje /mini:* příkazy do user scope (~/.claude/commands/mini) a nastaví statusline jen pokud žádný neexistuje, místo aby pouze vypsal hint; u lokální neinteraktivní instalace (CI) zůstane chování beze změny.

## Steps
- [done] Helper isGlobalInstall()
- [done] Postinstall: na global install nainstaluj prikazy i bez TTY
- [done] Postinstall: na global install nastav statusline bez dotazu
- [done] Testy postinstallu pro global vs lokalni install
- [done] Dokumentace: npm i -g instaluje do user scope + statusline
