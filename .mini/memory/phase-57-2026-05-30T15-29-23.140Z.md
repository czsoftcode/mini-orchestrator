# Fáze 57 — Mapa pro Kotlin

**Cíl:** Přidat kotlinMapper (mapKotlinFile) parsující .kt/.kts soubory (package, importy vč. as aliasů, top-level fun, typy class/interface/object/enum class/data class/sealed/annotation class, metody; default viditelnost public) a zapojit Kotlin do buildGraph (Lang, detectLang na .kt/.kts, hasMappableProject přes build.gradle.kts/*.kt) i hlášek v map.ts/cli.ts, vč. testů a zeleného buildu.

## Kroky
- [hotovo] Kostra kotlinMapperu + stripKotlin
- [hotovo] Package a importy (vč. as aliasů)
- [hotovo] Typy a top-level fun
- [hotovo] Zapojení do buildGraph
- [hotovo] Testy a zelený build

## Auto-commit
- Fáze 57: Mapa pro Kotlin (`794b7c7729d77b3b9afae4af433be6e2a540370a`)
