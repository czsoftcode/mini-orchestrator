# Fáze 71 — Skeleton .gitignore přežije npm publish

**Cíl:** npm publish vyřazuje soubory .gitignore z balíčku, takže po instalaci z npm chybí ve skeletonu a mini init/update ho do projektu nezaloží; uložit skeletonový gitignore pod neutrálním jménem (npm-safe) a při init/update ho do cílového projektu zapsat jako .gitignore.

## Kroky
- [hotovo] Přejmenovat skeleton .gitignore na gitignore
- [hotovo] Mapování zdroj→cíl v assets.ts
- [hotovo] syncSkeleton čte ze zdroje, píše na cíl
- [hotovo] Ověřit copy-assets.mjs a komentáře
- [hotovo] Testy a npm pack kontrola
- [hotovo] CHANGELOG a rebuild dist
