# Fáze 63 — Slash command /mini:init

**Cíl:** Přidat příkaz /mini:init, který z Claude Code spustí neinteraktivní inicializaci projektu (otázky se odbaví v session, uloží se přes mini init --apply ...) a po dokončení nabídne /mini:map a — když je mini v existujícím projektu (brownfield) — /mini:audit.

## Kroky
- [hotovo] Neinteraktivní mini init přes flagy
- [hotovo] Guard existujícího projektu bez --force
- [hotovo] Brownfield-aware nabídka po init
- [hotovo] CLI wiring nových flagů initu
- [hotovo] Slash command /mini:init
- [hotovo] Testy

## Auto-commit
- Fáze 63: Slash command /mini:init (`ef9757c5d6ae06d9b41cd9271fae500a081f08be`)
