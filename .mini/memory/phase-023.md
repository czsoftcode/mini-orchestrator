# Fáze 23 — Práce podle .mini/improvements.md, bod 1.

**Cíl:** Hotové W1 až W4

## Kroky
- [hotovo] W1: osiřelou doing fázi po podfázi dozavřít
- [hotovo] W2: Math.floor v commitPhase brání desetinnému ID
- [hotovo] W3: verify v auto módu bez TTY bezpečně
- [hotovo] W4: opakovaný done nepřehrává vyřešené verify body
- [hotovo] Doplnit testy pro W1–W4
- [hotovo] Zelené testy a čistý tsc --noEmit
