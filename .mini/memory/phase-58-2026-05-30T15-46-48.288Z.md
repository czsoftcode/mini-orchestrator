# Fáze 58 — Mapa pro Swift

**Cíl:** Přidat swiftMapper (mapSwiftFile) parsující .swift soubory (import, top-level func, typy class/struct/enum/protocol/extension/actor, metody a vlastnosti; respekt k modifikátorům viditelnosti) a zapojit Swift do buildGraph (Lang, detectLang na .swift, hasMappableProject přes Package.swift/*.swift) i hlášek v map.ts/cli.ts, včetně testů a zeleného buildu.

## Kroky
- [hotovo] Kostra swiftMapperu + stripSwift
- [hotovo] Importy
- [hotovo] Typy a top-level func
- [hotovo] Zapojení do buildGraph
- [hotovo] Testy a zelený build

## Auto-commit
- Fáze 58: Mapa pro Swift (`6efbf6ecac57a1b9b23125527ba67f6b547356f2`)
