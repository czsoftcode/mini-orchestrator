...
export async function skeletonDir() {
    ...
    throw new Error('Skeleton .mini se nepodařilo najít (chybí dist/skeleton i assets/skeleton). Spusť `npm run build`.');
}
/**
 ...
 */
export async function readSkeletonEntries() {
