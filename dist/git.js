 ...
 * jako `ok: false` se stderr ze gitu, ať to volající umí vypsat jako warning.
 */
export async function createTag(cwd, tag) {
 ...
 */
export async function pushTag(cwd, tag) {
 ...
 * commitu v UI undo.
 */
export async function headSubject(cwd) {
 ...
 */
export async function softResetTo(cwd, sha) {
